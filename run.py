...
def main():
    ...
    while True:
        ...
        print("2. 🚀 Запустить классический режим (20/5)")
        print("3. ⚡ Запустить экспресс-зарядку (10/2)") 
        print("4. 🧪 Запустить тестовый режим (10сек/5сек)")
        print("5. 🛑 Остановить текущий таймер")
